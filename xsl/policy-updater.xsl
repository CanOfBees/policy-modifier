...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="policy:Apply[@FunctionId='urn:oasis:names:tc:xacml:1.0:function:string-bag'][preceding-sibling::policy:SubjectAttributeDesignator[@AttributeId='urn:fedora:names:fedora:2.1:subject:loginId']]">
    <xsl:copy>
